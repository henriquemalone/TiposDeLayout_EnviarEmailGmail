...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(MainActivity.this, to.getText().toString(), Toast.LENGTH_SHORT).show();
                Toast.makeText(MainActivity.this, assunto.getText().toString(), Toast.LENGTH_SHORT).show();
                Toast.makeText(MainActivity.this, message.getText().toString(), Toast.LENGTH_SHORT).show();*/

                GmailSend gmail = new GmailSend(login.getText().toString(), password.getText().toString(), to.getText().toString(),
                        assunto.getText().toString(), message.getText().toString());

                Toast.makeText(MainActivity.this, "E-mail enviado!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.perfil) {
            Toast.makeText(MainActivity.this, "Perfil aberto", Toast.LENGTH_SHORT).show();
